...
void write_inode_table(int fd)
{
	...
	hello_world_inode.i_mode = EXT2_S_IFREG | EXT2_S_IRUSR | EXT2_S_IWUSR | EXT2_S_IXUSR | EXT2_S_IRGRP | EXT2_S_IXGRP | EXT2_S_IROTH | EXT2_S_IXOTH;
	...
	strcpy((char *)&hello_inode.i_block[0], target);
	// hello_inode.i_block[0] = HELLO_WORLD_FILE_BLOCKNO; // SHOULD BE PATH TO HELLO_WORLD!!
